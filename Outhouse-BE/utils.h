...
namespace Logger {
    ...
    void LogInternal(const char* file,
        const char* function,
        int line,
        ...
        Args&&... args)
    {
        ...
        else if (level == "WARN") colorCode = WarnColor;
        else if (level == "ERROR") colorCode = ErrorColor;
    ...
    inline void init_logging(bool allocate_console = false,
        bool to_file = false,
